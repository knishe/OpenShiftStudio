...
/**
 * 基于 MapperScannerConfigurer
 * <ul>
 * <li>追加includeFilters，excludeFilters属性。
 * <li>删除@Deprecated属性。
 * </ul>
 * @see org.mybatis.spring.mapper.MapperScannerConfigurer
 * @author clxy
 */
public class Scanner implements BeanDefinitionRegistryPostProcessor, InitializingBean,
		ApplicationContextAware, BeanNameAware {

	private Set<String> includeFilters = new HashSet<>();
	private Set<String> excludeFilters = new HashSet<>();

	public void setIncludeFilters(Set<String> includeFilters) {
	...
	public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry)
		...
		for (String s : includeFilters) {
			scanner.addIncludeFilter(new RegexPatternTypeFilter(Pattern.compile(s)));
		}
		for (String s : excludeFilters) {
			scanner.addExcludeFilter(new RegexPatternTypeFilter(Pattern.compile(s)));
		}
